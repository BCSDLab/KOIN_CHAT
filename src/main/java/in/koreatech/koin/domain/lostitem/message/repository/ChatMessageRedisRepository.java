package in.koreatech.koin.domain.lostitem.message.repository;
...
import in.koreatech.koin.domain.lostitem.message.exception.LostItemMessageErrorCode;
import in.koreatech.koin.domain.lostitem.message.exception.LostItemMessageException;
import in.koreatech.koin.domain.lostitem.message.model.ChatMessageEntity;
import in.koreatech.koin.domain.lostitem.message.model.redis.ChatMessageRedisEntity;
...
public class ChatMessageRedisRepository {
    ...
    public ChatMessageEntity save(ChatMessageEntity message) {
        try {
            ...
            throw new LostItemMessageException(LostItemMessageErrorCode.MESSAGE_SAVE_FAILED);
        }
        return message;
    }
        ...
        List<String> updatedMessages = messageJsonSet.stream()
            .map(value -> {
                try {
                    ...
                    throw new LostItemMessageException(LostItemMessageErrorCode.MESSAGE_UPDATE_FAILED);
                }
            })
            .toList();
