...
import in.koreatech.koin.domain.lostitem.chatroom.service.implement.UserBlockAppender;
import in.koreatech.koin.domain.lostitem.chatroom.service.implement.UserBlockReader;
import in.koreatech.koin.domain.lostitem.chatroom.service.implement.UserBlockUpdater;
...
public class LostItemChatRoomUserBlockService {
    ...
    public void checkUserBlock(Integer articleId, Integer chatRoomId, Integer userId) {
        ...
        if (blockedByMe || blockedByOther) {
            throw new LostItemChatRoomException(LostItemChatRoomErrorCode.BLOCKED_USER);
        }
    }
